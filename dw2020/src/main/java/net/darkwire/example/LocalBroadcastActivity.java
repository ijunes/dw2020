...
import net.darkwire.example.util.Logger;

public class LocalBroadcastActivity extends BaseSpiceActivity {
    ...
    protected void onResume() {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(myReceiver, new IntentFilter("net.darkwire.example.LOCAL_BROADCAST"));
    }
}
